...
async def call_us_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("پیام شما ثبت شد. با تشکر از تماس شما!", reply_markup=main_markup)
...
async def order_quantity(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("سفارش شما ثبت شد. از شما متشکریم!", reply_markup=main_markup)
    return ConversationHandler.END
